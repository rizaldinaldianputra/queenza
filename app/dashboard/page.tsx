...
// --- Mock Data ---
const SERVICES = [
  { id: 1, name: "Natural Classic", price: "Rp 250.000", duration: "90 min", img: "https://images.unsplash.com/photo-1587909209111-5097ee578ec3?auto=format&fit=crop&q=80&w=300" },
  { id: 2, name: "Russian Volume", price: "Rp 400.000", duration: "120 min", img: "https://images.unsplash.com/photo-1631214524020-7e18db9a8f92?auto=format&fit=crop&q=80&w=300" },
  { id: 3, name: "Lash Lift & Tint", price: "Rp 150.000", duration: "60 min", img: "https://images.unsplash.com/photo-1512496015851-a90fb38ba796?auto=format&fit=crop&q=80&w=300" },
  { id: 4, name: "Retouch (2 Weeks)", price: "Rp 150.000", duration: "60 min", img: "https://images.unsplash.com/photo-1583001931096-959e9ad7b535?auto=format&fit=crop&q=80&w=300" },
];

const TIME_SLOTS = ["09:00", "11:00", "13:00", "15:00", "17:00", "19:00"];

export default function DashboardPage() {
  // State untuk Booking Flow
    ...
    <div className="min-h-screen bg-pink-50/50 font-sans text-slate-800 pb-20">
      ...
      <nav className="bg-white/80 backdrop-blur-md border-b border-pink-100 sticky top-0 z-40 px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-pink-500 to-purple-500 p-[2px]">
      ...
      <main className="container mx-auto px-4 md:px-6 py-8 max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 space-y-6">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-pink-500 via-purple-600 to-yellow-500"></div>
              ...
              <div className="relative z-10 p-6 flex flex-col justify-between h-full text-white">
                <div className="flex justify-between items-start">
                  <span className="font-bold tracking-widest text-lg">GLOWLASH.</span>
          ...
          <div className="md:col-span-2">
                    ...
                    >
                        {SERVICES.map((srv) => (
                            ...
                            >
                                ...
                                <div>
                                    <h4 className="font-bold text-slate-800 group-hover:text-pink-600 transition-colors">{srv.name}</h4>
                ...
                {step === 3 && (
                     ...
                     >
                        ...
                        <button 
                            ...
                            className="w-full bg-gradient-to-r from-pink-600 to-purple-600 text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-pink-500/40 transition-all hover:scale-[1.02]"
                        >
                            Ya, Booking Sekarang
                        </button>
                     </motion.div>
            ...
            {step > 1 && step < 3 && (
                 <button onClick={() => setStep(step - 1)} className="mt-4 text-slate-400 hover:text-slate-600 text-sm font-medium">
                    &larr; Kembali
                </button>
            )}
